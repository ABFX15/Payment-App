...
export const PAYMENT_PROGRAM_ADDRESS =
  'JAVuBXeBZqXNtS73azhBDAoYaaAFfo4gWXoZe2e7Jf8H' as Address<'JAVuBXeBZqXNtS73azhBDAoYaaAFfo4gWXoZe2e7Jf8H'>;

export enum PaymentInstruction {
  Greet,
}

export function identifyPaymentInstruction(
  ...
  if (
    ...
    return PaymentInstruction.Greet;
  }
  throw new Error(
    'The provided instruction could not be identified as a payment instruction.'
  );
}

export type ParsedPaymentInstruction<
  TProgram extends string = 'JAVuBXeBZqXNtS73azhBDAoYaaAFfo4gWXoZe2e7Jf8H',
> = {
  instructionType: PaymentInstruction.Greet;
