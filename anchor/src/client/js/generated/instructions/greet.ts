...
import { PAYMENT_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof PAYMENT_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof PAYMENT_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? PAYMENT_PROGRAM_ADDRESS;
