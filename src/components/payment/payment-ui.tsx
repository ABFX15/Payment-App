...
import { usePaymentProgramId, useGetProgramAccountQuery, useGreetMutation } from './payment-data-access'

export function PaymentProgramExplorerLink() {
  const programId = usePaymentProgramId()
...
export function PaymentProgram() {
